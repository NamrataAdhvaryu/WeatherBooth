...
""".utf8)
    ...
    override func setUp() {
        ...
        systemUnderTest = WeatherData(lat: 12.344546, lon: 25.3445, timezone: "UTC", current: Currentt(dt: 1234, sunrise: 234, sunset: 77, temp: 67, feelsLike: 7676, pressure: 767, humidity: 767, dewPoint: 767, uvi: 767, clouds: 76, visibility: 65, windSpeed: 565, windDeg: 56, weather: [Weatherr(id: 87, main: "Cloudy", weatherDescription: "Go out and enjoy", icon: "Apple Logo")]), daily: [Dailyy(dt: 767, sunrise: 76, sunset: 76, temp: Tempp(day: 343, min: 565, max: 656, night: 656, eve: 65, morn: 78), feelsLike: FeelsLikee(day: 65, night: 65, eve: 98, morn: 76), pressure: 098, humidity: 767, dewPoint: 65, windSpeed: 545, windDeg: 45, weather: [Weatherr(id: 786, main: "Weather mai", weatherDescription: "Raining inside out", icon: "")], clouds: 878, pop: 7, uvi: 6, rain: 656)])
